...
# user name must be growmeup, otherwise the script has to be changed in the final lines
# a credentials JSON file must be created through Google and added to ~/speech/growmeup_credentials.json
# the "speech" folder in ~ cannot exist
